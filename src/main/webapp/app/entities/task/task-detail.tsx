  ...
  render() {
    ...
    return (
      <Row>
        <Col md="8">
          <h2>
            <Translate contentKey="cvServiceApp.task.detail.title">Task</Translate> [<b>{taskEntity.id}</b>]
          </h2>
          <dl className="jh-entity-details">
            ...
            <dd>{taskEntity.label}</dd>
            <dt>
              <Translate contentKey="cvServiceApp.task.experience">Experience</Translate>
            </dt>
            <dd>{taskEntity.experience ? taskEntity.experience.id : ''}</dd>
          </dl>
